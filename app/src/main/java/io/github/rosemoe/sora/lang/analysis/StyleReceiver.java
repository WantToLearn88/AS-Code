...
public interface StyleReceiver {
     ...
     */
    void setStyles(  AnalyzeManager sourceManager,   Styles styles,   Runnable action);
     ...
     */
    default void updateStyles(  AnalyzeManager sourceManager,   Styles styles,   StyleUpdateRange range) {
     ...
     * The implementation of this method should make sure that concurrent invocations to it are safe.
     */
    void setDiagnostics(  AnalyzeManager sourceManager,   DiagnosticsContainer diagnostics);

    /**
     * Set new provider for brackets highlighting
     */
    void updateBracketProvider(  AnalyzeManager sourceManager,   BracketsProvider provider);
