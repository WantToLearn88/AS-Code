...
public class ContentIO {
    ...
    public static Content createFrom(  InputStream stream) throws IOException {
    ...
    public static Content createFrom(  InputStream stream,   Charset charset) throws IOException {
    ...
    public static Content createFrom(  Reader reader) throws IOException {
     ...
     */
    public static void writeTo(  Content text,   OutputStream stream, boolean closeOnSucceed) throws IOException {
     ...
     * @param closeOnSucceed If true, the stream will be closed when operation is successfully
     */
    public static void writeTo(  Content text,   OutputStream stream,   Charset charset, boolean closeOnSucceed) throws IOException {
     ...
     * @param closeOnSucceed If true, the stream will be closed when operation is successfully
     */
    public static void writeTo(  Content text,   Writer writer, boolean closeOnSucceed) throws IOException {
