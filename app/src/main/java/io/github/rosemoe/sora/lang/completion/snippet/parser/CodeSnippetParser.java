...
public class CodeSnippetParser {
    ...
    private static void appendPlaceholderElement(  ArrayList<PlaceHolderElement> elements,   String t) {
        if (!elements.isEmpty()) {
    ...
    public static CodeSnippet parse(  String snippet,   List<PlaceholderDefinition> definitions) {
