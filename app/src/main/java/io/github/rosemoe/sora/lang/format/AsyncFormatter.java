...
public abstract class AsyncFormatter implements Formatter {
    ...
    public abstract TextRange formatAsync(  Content text,   TextRange cursorRange);
    ...
    public abstract TextRange formatRegionAsync(  Content text,   TextRange rangeToFormat,   TextRange cursorRange);
