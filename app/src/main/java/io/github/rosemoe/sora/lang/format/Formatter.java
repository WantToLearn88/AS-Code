...
public interface Formatter {
     ...
     */
    void format(  Content text,   TextRange cursorRange);
     ...
     * @param cursorRange   the positions of cursor. Start and end position may be the same.
     */
    void formatRegion(  Content text,   TextRange rangeToFormat,   TextRange cursorRange);
    ...
    interface FormatResultReceiver {
         ...
         */
        void onFormatSucceed(  CharSequence applyContent,   TextRange cursorRange);
