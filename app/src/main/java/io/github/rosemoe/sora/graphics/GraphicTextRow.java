...
public class GraphicTextRow {
    ...
    public void set(  Content content, int line, int start, int end,   List<Span> spans,   Paint paint,   RenderContext context) {
        this.paint = paint;
    ...
    public void setSoftBreaks(  List<Integer> softBreaks) {
