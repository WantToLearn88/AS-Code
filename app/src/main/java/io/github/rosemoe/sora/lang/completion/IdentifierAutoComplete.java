...
public class IdentifierAutoComplete {
    ...
    public void requireAutoComplete(
              ContentReference reference,   CharPosition position,
    ...
    public List<CompletionItem> createCompletionItemList(
              String prefix,   Identifiers userIdentifiers
    ) {
    ...
    public interface Identifiers {
         ...
         */
        void filterIdentifiers(  String prefix,   List<String> dest);
    ...
    public static class DisposableIdentifiers implements Identifiers {
        ...
        @Override
        public void filterIdentifiers(  String prefix,   List<String> dest) {
    ...
    public static class SyncIdentifiers implements Identifiers {
        ...
        public void identifierIncrease(  String identifier) {
            lock.lock();
            try {
        ...
        public void identifierDecrease(  String identifier) {
            lock.lock();
            try {
        ...
        public void filterIdentifiers(  String prefix,   List<String> dest, boolean waitForLock) {
            boolean acquired;
            if (waitForLock) {
                lock.lock();
                acquired = true;
