...
public class CodeEditor extends View implements ContentListener, Formatter.FormatResultReceiver {
     ...
     */
    public <T extends EditorBuiltinComponent> void replaceComponent(  Class<T> clazz,   T replacement) {
     ...
     */
    public void setSelectionHandleStyle(  SelectionHandleStyle style) {
...
*/
    ...
    public void indentOrCommitTab() {
        final var cursor = getCursor();
        if (cursor.isSelected()) indentSelection();
        else commitTab();
    ...
    public void setDiagnosticIndicatorStyle(  DiagnosticIndicatorStyle
     ...
     */
    public void setDividerMargin(  float marginLeft,   float marginRight) {
     ...
     */
    public void setLineNumberMarginLeft(  float lineNumberMarginLeft) {
     ...
     */
    public void moveOrExtendSelection(  SelectionMovement movement, boolean extend) {
        if (extend) {
     ...
     */
    public void extendSelection(  SelectionMovement movement) {
     ...
     */
    public void moveSelection(  SelectionMovement movement) {
     ...
     */
    public void pasteText(  CharSequence text) {
     ...
     */
    protected void copyTextToClipboard(  CharSequence text, int start, int end) {
        if (end < start) {
            return;
        }
     ...
     */
    public void setText(  CharSequence text,   Bundle extraArguments) {
     ...
     *                           to all languages and plugins in editor.
     */
    public void setText(  CharSequence text, boolean reuseContentObject,
    ...
    public void updateStyles(  Styles styles,   StyleUpdateRange range) {
     ...
     * connected to the device. Set to {@code false} by default.
     *
    ...
    @Override
    public void onFormatSucceed(  CharSequence applyContent,   TextRange
            cursorRange) {
        postInLifecycle(() -> {
            int line = cursor.getLeftLine();
