...
public class ContentChangeEvent extends Event {
    ...
    public ContentChangeEvent(  CodeEditor editor, int action,   CharPosition changeStart,   CharPosition changeEnd,   CharSequence textChanged, boolean causeByUndoManager) {
        super(editor);
        this.action = action;
        start = changeStart;
        end = changeEnd;
