...
public class EditorRenderer {
    ...
    public EditorRenderer(  CodeEditor editor) {
        this.editor = editor;
    ...
    protected void patchTextRegions(Canvas canvas, float textOffset, List<TextDisplayPosition> positions,   PatchDraw patch) {
        var styles = editor.getStyles();
