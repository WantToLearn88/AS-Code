...
public class TextUtils {
     ...
     */
    public static long countLeadingSpacesAndTabs(  CharSequence text) {
    ...
    public static int indexOf(  CharSequence text,   CharSequence pattern, boolean ignoreCase, int fromIndex) {
    ...
    public static int lastIndexOf(  CharSequence text,   CharSequence pattern, boolean ignoreCase, int fromIndex) {
        var len = pattern.length();
    ...
    public static boolean startsWith(  CharSequence text,   CharSequence pattern, boolean ignoreCase) {
