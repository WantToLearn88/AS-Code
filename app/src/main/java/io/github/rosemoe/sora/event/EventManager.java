...
public final class EventManager {
    ...
    public <T extends Event> SubscriptionReceipt<T> subscribe(  Class<T> eventType,   EventReceiver<T> receiver) {
    ...
    public <T extends Event> SubscriptionReceipt<T> subscribeAlways(  Class<T> eventType,   NoUnsubscribeReceiver<T> receiver) {
