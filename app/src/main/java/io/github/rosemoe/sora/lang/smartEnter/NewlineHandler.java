...
public interface NewlineHandler {
     ...
     */
    boolean matchesRequirement(  Content text,   CharPosition position,   Styles style);
    ...
    NewlineHandleResult handleNewline(  Content text,   CharPosition position,   Styles style, int tabSize);
