...
public class WordwrapLayout extends AbstractLayout {
    ...
    private void breakLine(int line, ContentLine sequence, List<Integer> breakpoints,   Paint paint) {
        int start = 0;
    ...
    @Override
    public RowIterator obtainRowIterator(int initialRow,   SparseArray<ContentLine> preloadedLines) {
