...
public class StylesUtils {
     ...
     */
    public static boolean checkNoCompletion(  Styles styles,   CharPosition pos) {
     ...
     */
    public static Span getSpanForPosition(  Styles styles,   CharPosition pos) {
     ...
     */
    public static Span getFollowingSpanForPosition(  Styles styles,   CharPosition pos) {
        return getSpanForPositionImpl(styles, pos, 1);
    }

     
    private static Span getSpanForPositionImpl(  Styles styles,   CharPosition pos, int spanIndexOffset) {
        var line = pos.line;
