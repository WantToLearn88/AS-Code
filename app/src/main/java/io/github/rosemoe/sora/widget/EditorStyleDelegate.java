...
public class EditorStyleDelegate implements StyleReceiver {
    ...
    EditorStyleDelegate(  CodeEditor editor) {
    ...
    @Override
    public void setStyles(  AnalyzeManager sourceManager,   Styles styles,   Runnable action) {
        var editor = editorRef.get();
    ...
    @Override
    public void setDiagnostics(  AnalyzeManager sourceManager,   DiagnosticsContainer diagnostics) {
        var editor = editorRef.get();
        if (editor != null && sourceManager == editor.getEditorLanguage().getAnalyzeManager()) {
    ...
    @Override
    public void updateBracketProvider(  AnalyzeManager sourceManager,   BracketsProvider provider) {
        var editor = editorRef.get();
    ...
    @Override
    public void updateStyles(  AnalyzeManager sourceManager,   Styles styles,   StyleUpdateRange range) {
        var editor = editorRef.get();
        if (editor != null && sourceManager == editor.getEditorLanguage().getAnalyzeManager()) {
