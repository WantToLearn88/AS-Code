...
public class Content implements CharSequence {
     ...
     */
    private static boolean textEquals(  ContentLine a,   ContentLine b) {
     ...
     */
    public boolean isValidPosition(  CharPosition position) {
        if (position == null) {
            return false;
        }
     ...
     */
    public void runReadActionsOnLines(int startLine, int endLine,   ContentLineConsumer consumer) {
        lock(false);
        try {
     ...
     * @param endLine   inclusive
     */
    public void runReadActionsOnLines(int startLine, int endLine,   ContentLineConsumer2 consumer) {
        lock(false);
        try {
    ...
    public interface ContentLineConsumer {
        ...
        void accept(int lineIndex,   ContentLine line,   Directions dirs);

    }

    public interface ContentLineConsumer2 {

        void accept(int lineIndex,   ContentLine line,   AbortFlag flag);
