...
public class CachedIndexer implements Indexer, ContentListener {
     ...
     */
    @VisibleForTesting
    void findIndexForward(  CharPosition start, int index,   CharPosition dest) {
     ...
     */
    @VisibleForTesting
    void findIndexBackward(  CharPosition start, int index,   CharPosition dest) {
        if (start.index < index) {
     ...
     */
    @VisibleForTesting
    void findLiCoForward(  CharPosition start, int line, int column,   CharPosition dest) {
        if (start.line > line) {
     ...
     */
    @VisibleForTesting
    void findLiCoBackward(  CharPosition start, int line, int column,   CharPosition dest) {
        if (start.line < line) {
