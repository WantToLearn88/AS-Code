...
public class EditorAutoCompletion extends EditorPopupWindow implements EditorBuiltinComponent {
    ...
    protected void onColorSchemeUpdate(  ColorSchemeUpdateEvent event,   Unsubscribe unsubscribe) {
        applyColorScheme();
    }

    protected void onContentChange(  ContentChangeEvent event,   Unsubscribe unsubscribe) {
    ...
    protected void onSelectionChange(  SelectionChangeEvent event,   Unsubscribe unsubscribe) {
    ...
    protected void onEditorScroll(  ScrollEvent event,   Unsubscribe unsubscribe) {
    ...
    protected void onKeyEvent(  EditorKeyEvent event,   Unsubscribe unsubscribe) {
    ...
    public void setLayout(  CompletionLayout layout) {
        this.layout = layout;
