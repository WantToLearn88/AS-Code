...
public class TextRange {
    ...
    public TextRange(  CharPosition start,   CharPosition end) {
        this.start = start;
        this.end = end;
    }
    ...
    public void setStart(  CharPosition start) {
        this.start = start;
    }
    ...
    public void setEnd(  CharPosition end) {
        this.end = end;
    }
     ...
     */
    public boolean isPositionInside(  CharPosition pos) {
